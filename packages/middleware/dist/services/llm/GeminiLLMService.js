...
class GeminiLLMService {
    constructor(apiKey, defaultModel = 'gemini-2.0-flash', errorHandler) {
        this.genAI = new generative_ai_1.GoogleGenerativeAI(apiKey);
        this.defaultModel = defaultModel;
        this.errorHandler = errorHandler || (0, api_error_handler_1.getApiErrorHandler)();
    }
    /**
    ...
    convertToGeminiSchema(schema) {
        ...
        if (schema.properties && typeof schema.properties === 'object') {
            ...
            for (const [key, value] of Object.entries(schema.properties)) {
                if (typeof value === 'object' && value !== null) {
                    const converted = this.convertToGeminiSchema(value);
        ...
        if (schema.items) {
            if (typeof schema.items === 'object' && !Array.isArray(schema.items)) {
                const convertedItems = this.convertToGeminiSchema(schema.items);
