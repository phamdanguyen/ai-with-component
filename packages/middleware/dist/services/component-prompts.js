...
exports.COMPONENT_GENERATION_SYSTEM = void 0;
exports.getChartPrompt = getChartPrompt;
exports.getTablePrompt = getTablePrompt;
exports.getCardPrompt = getCardPrompt;
exports.getFormPrompt = getFormPrompt;
exports.getListPrompt = getListPrompt;
exports.getSlidesPrompt = getSlidesPrompt;
exports.getReportPrompt = getReportPrompt;
 ...
 */
exports.COMPONENT_GENERATION_SYSTEM = `You are an expert UI component generator with deep knowledge of:
 ...
 */
function getChartPrompt(userQuery, toolResults) {
 ...
 */
function getTablePrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function getCardPrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function getFormPrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function getListPrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function getSlidesPrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function getReportPrompt(userQuery, toolResults) {
    const dataContext = buildDataContext(toolResults);
    return `## User Request
${userQuery}
 ...
 */
function buildDataContext(toolResults) {
 ...
 */
function getComponentPrompt(type, userQuery, toolResults) {
    switch (type) {
        case 'chart':
...
//# sourceMappingURL=component-prompts.js.map