...
exports.compassTool = void 0;
const tool_registry_1 = require("../tool-registry");
// Simple keyword mock
const mockVectorDB = {
    async search(query, limit) {
        const registry = tool_registry_1.ToolRegistry.getInstance();
        ...
        const scoredTools = allTools.map(tool => {
            ...
            keywords.forEach(kw => {
                if (tool.name.toLowerCase().includes(kw))
                    score += 5; // Higher weight for name match
...
//# sourceMappingURL=compass.tool.js.map