...
export class MockLLMService implements ITextGenerator, IStructuredGenerator {
  constructor(apiKey: string = 'mock', model: string = 'mock-model') {
  ...
  private generateMockComponentSpec(prompt: string): unknown {
