 ...
 */
export const BASE_SYSTEM_INSTRUCTION = `You are a helpful AI assistant providing clear, concise insights.
 ...
 */
export const TEXT_PROMPTS: Record<QueryType, string> = {
 ...
 */
export const SYSTEM_INSTRUCTIONS: Record<QueryType, string> = {
  'data-analysis': `${BASE_SYSTEM_INSTRUCTION}
...
- Provide context for numbers`,
  ...
  'code-explanation': `${BASE_SYSTEM_INSTRUCTION}
...
- Include tips for success`,
  ...
  'visualization': `${BASE_SYSTEM_INSTRUCTION}
...
- Consider audience and context`,
  ...
  'question': `${BASE_SYSTEM_INSTRUCTION}
...
- Keep it human`,
  ...
  'unknown': `${BASE_SYSTEM_INSTRUCTION}`,
};

/**
 * Helper function to get system instruction by query type
 */
export function getSystemInstructionForQueryType(queryType: QueryType): string {
  return SYSTEM_INSTRUCTIONS[queryType] || SYSTEM_INSTRUCTIONS['unknown'];
}

/**
 * Helper function to get prompt by query type
 */
export function getPromptForQueryType(queryType: QueryType): string {
  return TEXT_PROMPTS[queryType] || TEXT_PROMPTS['unknown'];
}
...
export const CLASSIFICATION_CONFIG = {
  ...
  fallbackType: 'chat' as QueryType,
